                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                ...
                                <span class="text-secondary">[ LW-01 ]</span>
                            </td>
                            <td>
                                <div class="input-group input-group-sm border border-dark h-100">
                                    ...
                                    <input type="text" class="form-control h-100 border-0 text-center" placeholder=""
