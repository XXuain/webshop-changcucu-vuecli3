<template>
    <div>
        ...
        <div class="text-right mt-3">
            <button class="btn btn-outline-primary" @click="openModal(true)">建立新的優惠券</button>
        </div>
                            ...
                            <div class="col-sm-8">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="unit" class="form-control" id="code" placeholder="請輸入編號" v-model="tempCoupon.code">
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="due_date" placeholder="請輸入到期日"
                                            value="6547658" v-model="tempCoupon.due_date">
                                    </div>
                                </div>
                                <hr>
    ...
    export default {
        ...
        methods: {
            ...
            updateCoupon(id) {
                ...
                this.$http[metods](api, { data: vm.tempCoupon }).then((res) => {
                    console.log(res.data);
                    if (res.data.success) {
                        vm.isLoading = false;
                        vm.getCoupons();
